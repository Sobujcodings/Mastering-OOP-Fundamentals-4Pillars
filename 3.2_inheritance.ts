{
  ...
  // tobe child class e constructor dewa lagbe noyto parameter recieve korbe kihabe.
  ...
  // tobe child cls r constructor e agee super call korte hobe (karon parent r constructor k age call korte hobe taholei parent e data gulo initiailize hobe then child sheta use korte parbe tai age parent constructor k call koro then tmr kaj) aijonno super use kori child e
  ...
  // parent r property gula initialize korar jonno, child theke super(name,age,address) call kore child r property gula padhiye dibo parent e
